...
namespace Teste
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var jwtConfiguration = Configuration.GetSafe<JwtConfiguration>();
            ...
            services.AddApplication(
                Configuration.GetSafe<ApplicationConfiguration>());

            services.AddUsuariosDbAdapter(
